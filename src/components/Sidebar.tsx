      ...
      >
            ...
            <div className="relative flex items-center h-20 px-6 flex-shrink-0 overflow-hidden">
                <div className="flex items-center gap-3 whitespace-nowrap w-full">
                    {/* Recreated Logo SVG based on branding */}
                    <div 
                        className="w-10 h-10 rounded-xl bg-white flex items-center justify-center shadow-lg shadow-[var(--primary-accent-color)]/20 flex-shrink-0 relative group cursor-pointer overflow-hidden" 
                        onClick={() => setView('Home')}
                    >
                         <svg viewBox="0 0 100 100" className="w-full h-full p-1.5" preserveAspectRatio="xMidYMid meet">
                            <defs>
                                <linearGradient id="logoGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                                    <stop offset="0%" stopColor="#2dd4bf" />   {/* Teal */}
                                    <stop offset="50%" stopColor="#34d399" />   {/* Green */}
                            ...
                            {/* Stylized 'E' Path */}
                            <path 
                                d="M25 20 H75 C82 20 85 25 85 30 V35 C85 40 80 43 75 43 H45 V50 H75 C82 50 85 53 85 58 V63 C85 68 80 73 75 73 H25 C18 73 15 68 15 60 V30 C15 23 18 20 25 20 Z" 
                    ...
                    <div className={`flex flex-col transition-all duration-300 origin-left justify-center ${isMiniMode ? 'opacity-0 scale-90 w-0' : 'opacity-100 scale-100 w-auto'}`}>
                        <h1 className="text-xl font-black tracking-[0.1em] text-white leading-none font-sans">
                            ELITEPRO
                        </h1>
                        <span className="text-[7px] uppercase tracking-[0.15em] text-slate-400 font-bold mt-1 leading-none whitespace-nowrap">
                            EVENTS & ADVERTISING
                        </span>
                    </div>
                </div>
            ...
            <div 
                className="flex-grow px-4 overflow-y-auto custom-scrollbar overflow-x-hidden"
                data-lenis-prevent
            >
