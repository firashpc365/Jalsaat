...
import { PlusIcon, SparkleIcon, MenuIcon, TrendingUpIcon, CashIcon, DocumentTextIcon, ImageIcon, ExpandIcon, CollapseIcon, SettingsIcon, ChartBarIcon, BoltIcon, InformationCircleIcon } from './common/icons';
...
export const Dashboard: React.FC<{
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar relative p-4 sm:p-8 space-y-10 pb-20">
      {/* Header Area */}
